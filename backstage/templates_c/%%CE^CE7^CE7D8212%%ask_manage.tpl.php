...
,'ask');">删除</a> | <a href="ask_manage.php?aid=<?php echo $this->_tpl_vars['i']['date']; ?>
&type=answer">查看回答</a></td>
					</tr>
...
" target="_blank">编辑</a> | <a class="pointer" onclick="del(<?php echo $this->_tpl_vars['i']['date']; ?>
,'answer');">删除</a></td>
					</tr>
				  <?php endforeach; endif; unset($_from); ?>
				  </tbody>
