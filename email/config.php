<?php
	$openinviter_settings=array(
		"username"=>"aaronleung",
		"private_key"=>"160c29c805c159acc4d6b28cd922172b",
		"cookie_path"=>'/tmp',
		"message_body"=>"You are invited to zerxon.info", // zerxon.info is the website on your account. If wrong, please update your account at OpenInviter.com
		"message_subject"=>" is inviting you to zerxon.info", // zerxon.info is the website on your account. If wrong, please update your account at OpenInviter.com
